...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        # ✅ Autoplay placed right above Clone button
        [
...
def stream_markup2(_, chat_id, bot_username):
    buttons = [
        ...
        # ✅ Added & Placed right above Clone button
        [
            styled_button(text="ᴀᴜᴛᴏᴘʟᴀʏ", callback_data=f"ADMIN Autoplay|{chat_id}", style=ButtonStyle.PRIMARY)
        ],
        [clone_button()],
...
def panel_markup_1(_, videoid, chat_id, bot_username):
    buttons = [
        ...
        [
            ...
            styled_button(
                text="ʟᴏᴏᴘ ↺", callback_data=f"ADMIN Loop|{chat_id}", style=ButtonStyle.PRIMARY
            ),
        ],
        [
            styled_button(
...
def panel_markup_5(_, videoid, chat_id, bot_username):
    buttons = [
        ...
        [
            ...
            styled_button(
                text="sᴋɪᴘ", callback_data=f"ADMIN Skip|{chat_id}", style=ButtonStyle.PRIMARY
            ),
        ],
        [
            styled_button(
